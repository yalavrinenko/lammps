...
PairWPMDCut::PairWPMDCut(LAMMPS *lmp) : Pair(lmp) {
  single_enable = 0;
...
void PairWPMDCut::compute(int eflag, int vflag) {
...
void PairWPMDCut::virial_eff_compute() {
  double *eradius = atom->eradius;
  double *erforce = atom->erforce;
  double e_virial;
  int *spin = atom->spin;
...
void PairWPMDCut::ev_tally_eff(int i, int j, int nlocal, int newton_pair,
...
void PairWPMDCut::settings(int narg, char **arg) {
  if (narg < 1)
...
void PairWPMDCut::coeff(int narg, char **arg) {
...
double PairWPMDCut::init_one(int i, int j) {
  if (setflag[i][j] == 0)
...
void PairWPMDCut::write_restart(FILE *fp) {
...
void PairWPMDCut::read_restart(FILE *fp) {
...
void PairWPMDCut::write_restart_settings(FILE *fp) {
...
void PairWPMDCut::read_restart_settings(FILE *fp) {
  if (comm->me == 0) {
...
void PairWPMDCut::min_xf_pointers(int /*ignore*/, double **xextra, double **fextra) {
...
void PairWPMDCut::min_xf_get(int /*ignore*/) {
  double *eradius = atom->eradius;
  double *erforce = atom->erforce;
  int *spin = atom->spin;
  int nlocal = atom->nlocal;
...
void PairWPMDCut::min_x_set(int /*ignore*/) {
  double *eradius = atom->eradius;
  int *spin = atom->spin;
  int nlocal = atom->nlocal;
...
double PairWPMDCut::memory_usage() {
